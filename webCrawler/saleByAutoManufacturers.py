...
PATH = '../汽车厂商销量/汽车厂商销量(2012.01-2012.12).csv'
...
def spider(i):
    j = i + 1
    url1 = 'https://xl.16888.com/factory-201201-201212-'
    url2 = '.html'
    url = (f'{url1}{j}{url2}')
    print(url)
    data = getHTML(url)
    ...
    try:
        ...
        for i in range(int(len(List1))):
            ...
            newList.append(saleAndPercentList[2 * i])
            newList.append(saleAndPercentList[2 * i + 1])
